...
| [07-relay-mesh-fanout.svg](07-relay-mesh-fanout.svg) | Event fanout: the **nsite-deck propagator** (not the relay) re-broadcasts each accepted event to all *other* connected peers (source-excluded, deduped); events fan out, blobs stay pull-only. |
